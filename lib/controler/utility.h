...
#define REQUEST_SERIALIZATION_FORMAT "{o_flag: %d, out_file: %s, t_flag: %d, seconds: %d, log_flag: %d, log_file: %s, mem_flag: %d, pid: %d, memkill_flag: %d, percentage: %f, arguments_flag: %d, arguments: %s}"
